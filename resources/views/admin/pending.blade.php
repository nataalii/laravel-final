          ...
          <table class="min-w-full divide-y divide-gray-300">
            ...
            <tbody class="divide-y divide-gray-200 bg-white">
                  ...
                  <tr>
                      ...
                      <td class="relative whitespace-nowrap text-red-500 text-center py-4 pl-3 pr-4 text-sm font-medium sm:pr-6">
                        <form action="{{ route('quiz.publish', $quiz->id)}}" method="POST">
                            @csrf
                            <button class="text-red-600 hover:text-indigo-900 pt-3 " >Publish</button>
                        </form>                     
                     </td>
                      <td class="relative whitespace-nowrap text-center py-4 pl-3 pr-4 text-sm font-medium sm:pr-6">
